...
const MealPlanner = () => {
  const { mealPlan, addMealToPlan, removeMealFromPlan, recipes } =
    useMealPlan();
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-x-auto">
        <div className="min-w-[700px]">
          <div className="grid grid-cols-8 bg-gray-50 border-b">
            <div className="p-4 font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">
              Meal Type
            </div>
          ...
          {mealTypes.map((mealType) => (
            ...
            >
              <div className="p-4 bg-gray-50 flex items-center sticky left-0 z-10">
              ...
              {weekDates.map((date) => {
                ...
                return (
                  <div
                    key={`${date}-${mealType}`}
                    className="p-2 min-h-24 border-l border-gray-100"
                  >
